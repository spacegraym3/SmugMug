...
var coverViewStore = new Ext.data.JsonStore({
    model: 'ImageInfo',
...
PMCLab.views.SmugMugCoverFlow = Ext.extend(Ext.Panel, {
    title: "Cover Flow",
    iconCls: "user",
    fullScreen: true,
    frame: true,
        ...
        Ext.apply(this, {
            ...
            dockedItems: [{
                ...
                items: [{
                    ...
                    text: "Action",
                    handler: function() {
                        //_albumListOverlay.show();
                        }
                }]
            }]
        });
        PMCLab.views.SmugMugCoverFlow.superclass.initComponent.apply(this, arguments);
    }
});
